#ifndef CRC_32_INLINE
#define CRC_32_INLINE
static unsigned long Crc32(void* in,int length)
{
	static unsigned long TABLE[256] = {
		...
		unsigned char *input = static_cast<unsigned char*>(in);
		unsigned long tmp = 0;
...
static __int64  Crc64( const void *data, const unsigned long len  )
{
